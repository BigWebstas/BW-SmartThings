/**
 *  Pushbullet Notifier 1.2.2
 *	4/28/2015
 *
 *  Copyright 2015 Eric Roberts & Big Webstas
 *
 ...
 */
definition(
    name: "Pushbullet Notifier 1.2.2",
    namespace: "baldeagle072",
    author: "Eric Roberts Modified by Big Webstas",
...
preferences {
    ...
    page(name: "pushbulletChooser", title: "Select a pushbullet device", nextPage: "pushbulletSetup", uninstall: true) {
    	section("Pushbullet Options") {
            ...
            label(name: "label", title: "App Name", required: false, multiple: false)
        }
    }
