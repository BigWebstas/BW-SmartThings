 ...
 *  2018-11-26 : fixed garage door lock silent to low volume issue  making it go silent to high volume only
 ...
 */
 ...
 metadata {
    definition (name: "Universal Enhanced ZigBee Lock2", namespace: "smartthings", author: "jhamstead")
    {
        capability "Actuator"
        capability "Lock"
        capability "Refresh"
    ...
    tiles(scale: 2) {
        ...
        standardTile("volumeTile", "device.volumeTile", inactiveLabel:false, width:2, height:2) {
            ...
            state "Silent", label:"Silent", action:"enableAudioHigh", icon:"st.custom.sonos.muted", nextState:"volumeSilentChanging", backgroundColor:"#ffffff"
            state "Low", label:"Low", action:"enableAudioLow", icon:"st.custom.sonos.unmuted", nextState:"volumeLowChanging", backgroundColor:"#7070ee"
