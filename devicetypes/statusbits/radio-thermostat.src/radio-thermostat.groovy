...
metadata {
    ...
    tiles {
        valueTile("temperature", "device.temperature", width: 2, height: 2) {
            state "temperature", label:'${currentValue}°', unit:"F", icon: "http://is4.mzstatic.com/image/thumb/Purple3/v4/6d/a4/ed/6da4ed6c-bcac-b12b-0c2b-71b1a7602cc3/source/512x512bb.jpg",
                backgroundColors:[
